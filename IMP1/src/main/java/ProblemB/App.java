...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (Session session = sessionFactory.openSession()) {
            ...
            Product cd=new CD();
            cd.setName("Music CD");
            cd.setDescription("New CD Description");
            ((CD) cd).setArtist("Micheal Jackson");

            session.persist(cd);

            Product dvd=new DVD();
            dvd.setName("Movie DVD");
            dvd.setDescription("New CD Description");
            ((DVD) dvd).setGenre("Action");

            session.persist(dvd);

            Product book=new Book();
            book.setName("Fiction Book");
            book.setDescription("Fiction Book Description");
            ((Book) book).setTitle("The story of the world");
